...
#train_df.to_csv("train_norm_only_user_true.csv", index=False)
#test_df.to_csv("test_norm_only_user_true.csv", index=False)
train_df.to_csv("train_norm_only_user_true_1_day.csv", index=False)
test_df.to_csv("test_norm_only_user_true_1_day.csv", index=False)
