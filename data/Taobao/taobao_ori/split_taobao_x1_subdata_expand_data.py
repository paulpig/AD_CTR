...
# extract positive samples, and concat train_df
ext_df = all_df[all_df['clk']=='1']
#pdb.set_trace()
...
train_df.to_csv("train_rm_self_sub_v1.csv", index=False)
test_df.to_csv("test_rm_self_sub_v1.csv", index=False)
