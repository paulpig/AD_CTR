...
for idx, row in train_df.iterrows():
    ...
    click_cate_history_col.append("^".join(click_cate_history))
    if click == "1":
        click_cate_sequence_queue[user_id].append(cate_id)

train_df.loc[:, "click_sequence"] = click_history_col
train_df.loc[:, "click_cate_sequence"] = click_cate_history_col
...
train_df.to_csv("train_cate.csv", index=False)
test_df.to_csv("test_cate.csv", index=False)
