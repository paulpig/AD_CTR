...
# save dict
dict_path ="./train_data_dict_only_pos_c_ua.npz"
...
pdb.set_trace()
# 3. 根据日志构建hypergraph
sp.save_npz('./user_id_Item_id_net_v2_ori_num_replace_customer_true_only_pos_c_ua.npz', UserItemNet)

path = "userItmeDict_v2_ori_num_replace_customer_true_only_pos_ua.pk"
