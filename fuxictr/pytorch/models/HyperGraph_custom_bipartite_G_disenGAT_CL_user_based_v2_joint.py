...
class HyperGraphCustomBipartiteDisenGATCLUserV2Joint(BaseModel):
    def __init__(self,
                #  adj_user_mat,
                 feature_map,
                 model_id="GNN",
                 ...
                 **kwargs):
        # super(HyperGraphCustomBipartiteDisenGATCLUserV2Joint, self).__init__()
        super(HyperGraphCustomBipartiteDisenGATCLUserV2Joint, self).__init__(feature_map, 
                                  model_id=model_id, 
                                  gpu=gpu, 
