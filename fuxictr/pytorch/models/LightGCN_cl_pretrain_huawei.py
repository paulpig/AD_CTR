...
class LightGCNCLHuaWei(nn.Module):
    def __init__(self,
                #  adj_user_mat,
                 gpu=-1,
                 graph_layer=1,
        ...
        super(LightGCNCLHuaWei, self).__init__()
        ...
        path_origin = "../data/huawei/u_c_pos_mat_new_idx_1_day.npz" #3 day train data
        ...
        path = "../data/huawei/u_c_pos_mat_pre_norm_new_idx_1_day.npz" #1 day

        # self.inter_path = "../data/Taobao/taobao_ori/train_data_u_clist_new_idx.npz" #3 day
        self.inter_path = "../data/huawei/train_data_u_clist_new_idx_1_day.npz" #1 day
        ...
        self.path_pretrain_user_emb_path = "../data/huawei/u_c_pos_emb_new_idx_1_day.h5" # 1 day
        # 这个路径不要变;
        ...
        self.u_at_hypergraph_path = "../data/huawei/u_at_hypergraph_1_day_rm_lfreq_more_paddings.npz"
        # self.save_pre_norm_u_at_hypergraph_path = "../data/Taobao/taobao_ori/pre_norm_u_at_hypergraph_1_day_rm_lfreq.npz"
        self.save_pre_norm_u_at_hypergraph_path = "../data/huawei/pre_norm_u_at_hypergraph_1_day_rm_lfreq_more_paddings.npz"
        ...
        with open('../data/huawei/u2_uat_list_new_idx_rm_lfreq.pk', "rb") as f: #与CTR模型编码一致;
        ...
        self.countIndepentHyperEdgeNum()
