...
for idx, row in behavior_df.iterrows():
    ...
    if item_id in item_voc_set and user_id in user_voc_set and int(click) == 1:
        pass
    else:
        continue
...
# save dict
dict_path ="./train_data_dict_only_pos_ad_user_v1.npz"
...
#pdb.set_trace()
# 3. 根据日志构建hypergraph
sp.save_npz('./user_id_Item_id_net_v2_ori_num_true_ad_user_v1.npz', UserItemNet)

path = "userItmeDict_v2_ori_num_true_ad_user_v1.pk"
