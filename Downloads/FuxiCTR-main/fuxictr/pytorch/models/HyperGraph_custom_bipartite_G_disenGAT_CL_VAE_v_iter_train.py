...
class HyperGraphCustomBipartiteDisenGATVAEV3IterTrain(nn.Module):
    def __init__(self,
                #  adj_user_mat,
                 gpu=-1,
                 graph_layer=1,
                 ...
                 add_norm=False,
                 channels=2):
        super(HyperGraphCustomBipartiteDisenGATVAEV3IterTrain, self).__init__()
        ...
        self.u_at_mlps = [nn.Linear(self.user_at_dim, self.user_at_dim) for _ in range(len(self.each_u_at_num))]
    ...
    def save_embeddings(self, save_model_name="disengcn", use_vae=True):
        ...
        if save_model_name == "embedding":
            ...
            user_embeddings_gnn, items_emb_lookup = all_embeddings[:self.user_voc_len], all_embeddings[self.user_voc_len:]
