...
class HyperGraphCustomBipartite(nn.Module):
    def __init__(self,
                #  adj_user_mat,
                 gpu=-1,
                 graph_layer=1,
                 ...
                 weight_decay=1e-5):
        super(HyperGraphCustomBipartite, self).__init__()
        ...
        self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_output_epoch_20_ori_num_top30_customer_user_true_bipartile.h5" # 训练20个epoch, 保存输出的user representation;
