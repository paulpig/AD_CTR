...
class HyperGraph(nn.Module):
    def __init__(self,
        ...
        # path_origin = "../data/Taobao/taobao_ori/user_id_Item_id_net_v2.npz"
        # path_origin = "../data/Taobao/taobao_ori/user_id_Item_id_net_v2_ori_num.npz" #构建item-user hypergraph
        path_origin = "../data/Taobao/taobao_ori/user_id_Item_id_net_v2_ori_num_true.npz" #构建item-user hypergraph
        ...
        # path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_30.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户;
        # path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_30.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户;
        # path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_30_ori_num.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户;
        # path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_100_ori_num.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户;
        path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_100_ori_num_true.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户;
        ...
        # path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_30_ori_num_replace_customer.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户; customer-user graph;
        # self.path_train_data = "../data/Taobao/taobao_ori/user_item_train_data_test_v2.npz" #训练数据, <user, in_session_positive_users>, <user, out_session_negative_users>
        # self.path_train_data = "../data/Taobao/taobao_ori/user_item_train_data_ori_num.npz" #训练数据, <user, in_session_positive_users>, <user, out_session_negative_users>
        self.path_train_data = "../data/Taobao/taobao_ori/user_item_train_data_ori_num_true.npz" #训练数据, <user, in_session_positive_users>, <user, out_session_negative_users>
        # self.path_train_data = "../data/Taobao/taobao_ori/user_item_train_data_top30_ori_num_replace_customer.npz" #训练数据, <user, in_session_positive_users>, <user, out_session_negative_users>; customer-user graph;
        # self.path_dict_path = "../data/Taobao/taobao_ori/userItmeDict_v2.pk" # 存在ID与index的字典, <user_id, index>, <item_id, index>
        # self.path_dict_path = "../data/Taobao/taobao_ori/userItmeDict_v2_ori_num.pk" # 存在ID与index的字典, <user_id, index>, <item_id, index>
        self.path_dict_path = "../data/Taobao/taobao_ori/userItmeDict_v2_ori_num_true.pk" # 存在ID与index的字典, <user_id, index>, <item_id, index>
        ...
        # self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final.h5" # 训练10个epoch, 保存输入的embedding;
        # self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_epoch_20.h5" # 训练20个epoch, 保存输入的embedding;
        # self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_output_epoch_20_add_norm.h5" # 训练20个epoch, 保存输出的user representation;
        # self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_output_epoch_20_ori_num_output.h5" # 训练20个epoch, 保存输出的user representation;
        # self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_output_epoch_20_ori_num_input_v2.h5" # 训练20个epoch, 保存输出的user representation;
        self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_output_epoch_20_ori_num_top100_ad_user_true.h5" # 训练20个epoch, 保存输出的user representation;
