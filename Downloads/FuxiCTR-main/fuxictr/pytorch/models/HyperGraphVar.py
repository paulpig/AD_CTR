...
class HyperGraph(nn.Module):
    def __init__(self,
        ...
        path_origin = "../data/Taobao/taobao_ori/user_id_Item_id_net_v2_ori_num.npz"
        ...
        path = "../data/Taobao/taobao_ori/user_id_Item_id_pre_adj_mat_filter_top_100_ori_num_var.npz" #超图卷积处理后的user-user graph, 只保留每个用户前N个相似的用户;
        ...
        self.path_pretrain_user_emb_path = "../data/Taobao/taobao_ori/user_emb_hypergraph_dim10_final_output_epoch_20_ori_num.h5" # 训练20个epoch, 保存输出的user representation;
    ...
    def normalizeAdj(self, data, path):
        ...
        try:
            ...
            H = data.todok()
            H_T = H.T
            DHBH_T = H.dot(H_T) #耗时的大头; (user, user)
