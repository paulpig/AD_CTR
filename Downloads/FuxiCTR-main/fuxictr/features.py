    ...
    def fit_feature_col(self, feature_column, feature_values, min_categr_count=1, num_buckets=10):
        ...
        if feature_type == "numeric":
            ...
            if encoder == "":
                ...
                # write dict
                with open(os.path.join(self.data_dir, "{}2id.h5".format(name)) , 'wb') as w_f:
                    pickle.dump(tokenizer.vocab, w_f)
        ...
        # if name == "userid":
        #     # save userid dict
        #     print("save the dict of {}: ".format(name))
        #     with open(os.path.join(self.data_dir, 'user2id.h5') , 'wb') as w_f:
        #         pickle.dump(tokenizer.vocab, w_f)
        
        # if name == "customer":
        #     # save userid dict
        #     print("save the dict of {}: ".format(name))
        #     with open(os.path.join(self.data_dir, 'customer2id.h5') , 'wb') as w_f:
        #         pickle.dump(tokenizer.vocab, w_f)
        #     # pdb.set_trace() # tokenizer.vocab
